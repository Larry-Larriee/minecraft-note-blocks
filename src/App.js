...
function App() {
  ...
  useEffect(() => {
    ...
    const animateNotes = (number) => {
      ...
      notes[number].current.classList.remove("content-hidden");

      setTimeout(() => {
        notes[number].current.classList.remove("rise-up");
        notes[number].current.classList.add("content-hidden");
      }, 1250);
    }
    ...
    <div className="App">
      ...
      <div className="note-block">
        ...
        <section className="note-block-notes">
          <img ref={note1} src={noteRed1} alt="Note" draggable="false" className='no-select content-hidden' />
          <img ref={note2} src={noteOrange1} alt="Note" draggable="false" className='no-select content-hidden' />
          <img ref={note3} src={noteOrange2} alt="Note" draggable="false" className='no-select content-hidden' />
          <img ref={note4} src={noteBlue1} alt="Note" draggable="false" className='no-select content-hidden' />
          <img ref={note5} src={noteBlue2} alt="Note" draggable="false" className='no-select content-hidden' />
          <img ref={note6} src={noteBlue3} alt="Note" draggable="false" className='no-select content-hidden' />
          <img ref={note7} src={noteGreen1} alt="Note" draggable="false" className='no-select content-hidden' />
          <img ref={note8} src={noteGreen2} alt="Note" draggable="false" className='no-select content-hidden' />
          <img ref={note9} src={noteGreen3} alt="Note" draggable="false" className='no-select content-hidden' />
          <img ref={note10} src={notePurple1} alt="Note" draggable="false" className='no-select content-hidden' />
        </section>
